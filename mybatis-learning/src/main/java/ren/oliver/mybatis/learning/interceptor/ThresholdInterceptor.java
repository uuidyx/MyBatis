package ren.oliver.mybatis.learning.interceptor;
...
@Intercepts({
	    ...
	    // @Signature(type=StatementHandler.class,method="query",args={MappedStatement.class,Object.class, RowBounds
...
public class ThresholdInterceptor implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        if(runTime>=threshold){
            ...
            System.out.println("SQL：“" + statement.toString() + "”执行时间为：" + runTime+ "毫秒，已超过阈值。");
        }
        return ret;
    }
